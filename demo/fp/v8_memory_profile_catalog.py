...
V8_MEMORY_SNAPSHOTS: tuple[V8MemorySnapshot, ...] = (
    ...
    V8MemorySnapshot(
        id="android_webview_success_loaded_page_user_sample",
        total_js_heap_size=66_508_722,
        used_js_heap_size=23_200_000,
        platforms=("android",),
        weight=24,
        evidence="user-test/success.json Android successful browser sample",
    ),
    V8MemorySnapshot(
        id="android_pixel4_webview150_https_initial_bucket",
        total_js_heap_size=10_000_000,
        used_js_heap_size=10_000_000,
        platforms=("android",),
        weight=24,
        evidence="demo/fp/android_webview_150_pixel4_https.json",
    ),
    V8MemorySnapshot(
