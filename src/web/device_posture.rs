...
#[derive(Default)]
pub(crate) struct DevicePostureStore {
    constructor: crate::webidl::RealmConstructor,
    records: HashMap<i32, PostureRecord>,
}
pub(crate) fn prepare(i: &mut v8::OwnedIsolate) {
    i.set_slot(DevicePostureStore::default());
}
pub(crate) fn install(s: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let c = ensure(s)?;
    crate::webidl::define_global(s, "DevicePosture", c.into())
}
fn ensure<'s>(s: &mut v8::PinScope<'s, '_>) -> Result<v8::Local<'s, v8::Function>, String> {
    if let Some(v) = s
        .get_slot::<DevicePostureStore>()
    ...
    s.get_slot_mut::<DevicePostureStore>()
        .unwrap()
        .constructor
...
pub(crate) fn create<'s>(
    ...
    if crate::webidl::set_platform_prototype(s, o, p.into()) != Some(true) {
        return Err("cannot create DevicePosture".to_owned());
    }
    super::event_target::attach(s, o);
    let posture = crate::fingerprint::edge(s)
        .hardware_devices
        .device_posture
        .clone();
    s.get_slot_mut::<DevicePostureStore>()
...
fn record(s: &v8::PinScope<'_, '_>, o: v8::Local<'_, v8::Object>) -> Option<PostureRecord> {
    s.get_slot::<DevicePostureStore>()?
        .records
...
fn get_type(
    ...
    if let Some(v) = record(s, a.this())
        && let Some(x) = v8::String::new(s, &v.posture)
    {
        r.set(x.into())
    } else {
...
fn set_handler(
    ...
    if let Some(v) = s
        .get_slot_mut::<DevicePostureStore>()
