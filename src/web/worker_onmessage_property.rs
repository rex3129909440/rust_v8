pub(crate) fn define(
    ...
    crate::webidl::define_accessor(s, p, "onmessage", get, set)
}
fn get(s: &mut v8::PinScope<'_, '_>, a: v8::FunctionCallbackArguments<'_>, r: v8::ReturnValue<'_>) {
    super::worker::get_handler(s, a, super::worker::HandlerKind::Message, r);
}
fn set(s: &mut v8::PinScope<'_, '_>, a: v8::FunctionCallbackArguments<'_>, _: v8::ReturnValue<'_>) {
    super::worker::set_handler(s, a, super::worker::HandlerKind::Message);
}
