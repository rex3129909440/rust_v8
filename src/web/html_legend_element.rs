...
#[derive(Default)]
pub(crate) struct HtmlLegendElementStore {
    pub(crate) constructor: crate::webidl::RealmConstructor,
    pub(crate) align: HashMap<i32, String>,
}
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(HtmlLegendElementStore::default());
}
pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "HTMLLegendElement", constructor.into())
}
pub(crate) fn ensure_constructor<'s>(
    ...
    super::html_legend_element_form_property::define(scope, prototype)?;
    super::html_legend_element_align_property::define(scope, prototype)?;
    crate::webidl::finish_constructor(scope, prototype, constructor)?;
    let stored = v8::Global::new(scope, constructor);
    scope
        .get_slot_mut::<HtmlLegendElementStore>()
        .ok_or_else(|| "HTMLLegendElement state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn create<'s>(
    ...
    if crate::webidl::set_platform_prototype(scope, object, prototype.into()) != Some(true) {
        return Err("cannot create HTMLLegendElement".to_owned());
    }
    super::html_element::attach(scope, object, "LEGEND");
    scope
        .get_slot_mut::<HtmlLegendElementStore>()
        .ok_or_else(|| "HTMLLegendElement state was not prepared".to_owned())?
        .align
