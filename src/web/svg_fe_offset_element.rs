...
#[derive(Default)]
pub(crate) struct SvgFeOffsetElementStore {
...
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(SvgFeOffsetElementStore::default());
}

pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "SVGFEOffsetElement", constructor.into())
}
...
pub(crate) fn ensure_constructor<'s>(
    ...
    let existing = scope
        .get_slot::<SvgFeOffsetElementStore>()
    ...
    super::svg_fe_offset_element_in1_property::define(scope, prototype)?;
    super::svg_fe_offset_element_dx_property::define(scope, prototype)?;
    super::svg_fe_offset_element_dy_property::define(scope, prototype)?;
    super::svg_fe_offset_element_x_property::define(scope, prototype)?;
    super::svg_fe_offset_element_y_property::define(scope, prototype)?;
    super::svg_fe_offset_element_width_property::define(scope, prototype)?;
    super::svg_fe_offset_element_height_property::define(scope, prototype)?;
    super::svg_fe_offset_element_result_property::define(scope, prototype)?;
    ...
    scope
        .get_slot_mut::<SvgFeOffsetElementStore>()
        .ok_or_else(|| "SVGFEOffsetElement state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn create<'s>(
    ...
    let constructor = ensure_constructor(scope)?;
    let object =
        super::svg_element::create_with_constructor(scope, constructor, "feOffset", owner)?;
    let input = super::svg_animated_string::create(scope, "")?;
    let dx = super::svg_animated_number::create(scope, 0.0)?;
    let dy = super::svg_animated_number::create(scope, 0.0)?;
...
pub(crate) fn illegal_constructor(
    ...
    crate::webidl::throw_type_error(
        s,
        "Failed to construct 'SVGFEOffsetElement': Illegal constructor",
    )
}
pub(crate) fn record(s: &v8::PinScope<'_, '_>, o: v8::Local<'_, v8::Object>) -> Option<Record> {
    s.get_slot::<SvgFeOffsetElementStore>()?
        .records
