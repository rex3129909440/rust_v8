#[derive(Default)]
pub(crate) struct GpuComputePipelineStore {
    constructor: crate::webidl::RealmConstructor,
}

pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(GpuComputePipelineStore::default());
}

pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "GPUComputePipeline", constructor.into())
}
...
fn ensure_constructor<'s>(
    ...
    if let Some(value) = scope
        .get_slot::<GpuComputePipelineStore>()
    ...
    scope
        .get_slot_mut::<GpuComputePipelineStore>()
        .ok_or_else(|| "GPUComputePipeline state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn create<'s>(
    ...
    if crate::webidl::set_platform_prototype(scope, object, prototype.into()) != Some(true) {
        return Err("cannot create GPUComputePipeline".to_owned());
    }
...
fn get_bind_group_layout(
    ...
    match super::gpu_bind_group_layout::create(scope, String::new()) {
        Ok(layout) => result.set(layout.into()),
        Err(message) => crate::webidl::throw_type_error(scope, &message),
    }
}

pub(crate) fn cleanup_realm(scope: &mut v8::PinScope<'_, '_>, realm_id: i32) {
    if let Some(store) = scope.get_slot_mut::<GpuComputePipelineStore>() {
