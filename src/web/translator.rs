...
fn measure(
    ...
    if record(s, a.this()).is_none() {
        crate::webidl::reject_illegal_invocation_promise(s, "Translator", "measureInputUsage", r);
        return;
    }
...
fn translate(
    ...
    if record(s, a.this()).is_none() {
        crate::webidl::reject_illegal_invocation_promise(s, "Translator", "translate", r);
        return;
    }
