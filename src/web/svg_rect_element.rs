...
#[derive(Default)]
pub(crate) struct SvgRectElementStore {
...
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(SvgRectElementStore::default());
}

pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "SVGRectElement", constructor.into())
}
...
pub(crate) fn ensure_constructor<'s>(
    ...
    super::svg_rect_element_x_property::define(scope, prototype)?;
    super::svg_rect_element_y_property::define(scope, prototype)?;
    super::svg_rect_element_width_property::define(scope, prototype)?;
    super::svg_rect_element_height_property::define(scope, prototype)?;
    super::svg_rect_element_rx_property::define(scope, prototype)?;
    super::svg_rect_element_ry_property::define(scope, prototype)?;
    ...
    scope
        .get_slot_mut::<SvgRectElementStore>()
        .ok_or_else(|| "SVGRectElement state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn illegal_constructor(
    ...
    crate::webidl::throw_type_error(
        scope,
        "Failed to construct 'SVGRectElement': Illegal constructor",
    );
}
