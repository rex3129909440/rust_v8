...
pub(crate) fn install(s: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    super::window_event_handler_support::define(s, "ontouchcancel", get, set)
}
pub(crate) fn dispatch(
    s: &mut v8::PinScope<'_, '_>,
    t: v8::Local<'_, v8::Object>,
    e: v8::Local<'_, v8::Object>,
    k: &str,
) {
    if k == "touchcancel" && super::window_event_handler_support::is_window(s, t) {
        let h = s.get_slot::<Store>().and_then(|x| x.handler.clone());
        super::window_event_handler_support::invoke(s, t, e, h);
    }
}
