#[derive(Default)]
pub(crate) struct SvgFeFuncGElementStore {
    constructor: crate::webidl::RealmConstructor,
}
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(SvgFeFuncGElementStore::default());
}
pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let c = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "SVGFEFuncGElement", c.into())
}
fn ensure_constructor<'s>(
    scope: &mut v8::PinScope<'s, '_>,
) -> Result<v8::Local<'s, v8::Function>, String> {
    let old = scope
        .get_slot::<SvgFeFuncGElementStore>()
    ...
    scope
        .get_slot_mut::<SvgFeFuncGElementStore>()
        .ok_or_else(|| "SVGFEFuncGElement state was not prepared".to_owned())?
        .constructor
...
fn illegal_constructor(
    ...
    crate::webidl::throw_type_error(
        s,
        "Failed to construct 'SVGFEFuncGElement': Illegal constructor",
    )
}
