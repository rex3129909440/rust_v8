#[derive(Default)]
pub(crate) struct OnDeviceOrientationStore {
    handler: Option<v8::Global<v8::Value>>,
}

pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(OnDeviceOrientationStore::default());
}
...
pub(crate) fn dispatch(
    ...
    let handler = scope
        .get_slot::<OnDeviceOrientationStore>()
...
fn set_handler(
    ...
    if let Some(store) = scope.get_slot_mut::<OnDeviceOrientationStore>() {
