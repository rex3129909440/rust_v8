#[derive(Default)]
pub(crate) struct OnTransitionRunStore {
    handler: Option<v8::Global<v8::Value>>,
}
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(OnTransitionRunStore::default());
}
pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    super::window_event_handler_support::define(scope, "ontransitionrun", get_handler, set_handler)
}
...
fn set_handler(
    ...
    if let Some(store) = scope.get_slot_mut::<OnTransitionRunStore>() {
