...
#[derive(Clone)]
struct CssPositionTryRuleRecord {
    name: String,
    style: v8::Global<v8::Object>,
}

#[derive(Default)]
pub(crate) struct CssPositionTryRuleStore {
    constructor: crate::webidl::RealmConstructor,
    records: HashMap<i32, CssPositionTryRuleRecord>,
}

pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(CssPositionTryRuleStore::default());
}

pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "CSSPositionTryRule", constructor.into())
}
...
fn ensure_constructor<'s>(
    ...
    if let Some(constructor) = scope
        .get_slot::<CssPositionTryRuleStore>()
    ...
    scope
        .get_slot_mut::<CssPositionTryRuleStore>()
        .ok_or_else(|| "CSSPositionTryRule state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn create<'s>(
    ...
    if crate::webidl::set_platform_prototype(scope, object, prototype.into()) != Some(true) {
        return Err("cannot create CSSPositionTryRule".to_owned());
    }
    let style = super::css_position_try_descriptors::create(scope, body, Some(object))?;
    ...
    scope
        ...
        .insert(
            ...
            CssPositionTryRuleRecord { name, style },
        );
    Ok(object)
}
...
) -> Option<CssPositionTryRuleRecord> {
    scope
        .get_slot::<CssPositionTryRuleStore>()?
        .records
