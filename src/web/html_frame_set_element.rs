...
pub(crate) struct FrameSetRecord {
    pub(crate) cols: String,
    pub(crate) rows: String,
    pub(crate) handlers: HashMap<&'static str, v8::Global<v8::Value>>,
}
#[derive(Default)]
pub(crate) struct HtmlFrameSetElementStore {
    pub(crate) constructor: crate::webidl::RealmConstructor,
    pub(crate) records: HashMap<i32, FrameSetRecord>,
}
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(HtmlFrameSetElementStore::default());
}
pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "HTMLFrameSetElement", constructor.into())
}
pub(crate) fn ensure_constructor<'s>(
    ...
    if let Some(constructor) = scope
        .get_slot::<HtmlFrameSetElementStore>()
    ...
    super::html_frame_set_element_cols_property::define(scope, prototype)?;
    super::html_frame_set_element_rows_property::define(scope, prototype)?;
    super::html_frame_set_element_onblur_property::define(scope, prototype)?;
    super::html_frame_set_element_onerror_property::define(scope, prototype)?;
    super::html_frame_set_element_onfocus_property::define(scope, prototype)?;
    super::html_frame_set_element_onload_property::define(scope, prototype)?;
    super::html_frame_set_element_onresize_property::define(scope, prototype)?;
    super::html_frame_set_element_onscroll_property::define(scope, prototype)?;
    super::html_frame_set_element_onafterprint_property::define(scope, prototype)?;
    super::html_frame_set_element_onbeforeprint_property::define(scope, prototype)?;
    super::html_frame_set_element_onbeforeunload_property::define(scope, prototype)?;
    super::html_frame_set_element_onhashchange_property::define(scope, prototype)?;
    super::html_frame_set_element_onlanguagechange_property::define(scope, prototype)?;
    super::html_frame_set_element_onmessage_property::define(scope, prototype)?;
    super::html_frame_set_element_onmessageerror_property::define(scope, prototype)?;
    super::html_frame_set_element_onoffline_property::define(scope, prototype)?;
    super::html_frame_set_element_ononline_property::define(scope, prototype)?;
    super::html_frame_set_element_onpagehide_property::define(scope, prototype)?;
    super::html_frame_set_element_onpageshow_property::define(scope, prototype)?;
    super::html_frame_set_element_onpopstate_property::define(scope, prototype)?;
    super::html_frame_set_element_onrejectionhandled_property::define(scope, prototype)?;
    super::html_frame_set_element_onstorage_property::define(scope, prototype)?;
    super::html_frame_set_element_onunhandledrejection_property::define(scope, prototype)?;
    super::html_frame_set_element_onunload_property::define(scope, prototype)?;
    super::html_frame_set_element_orientation_handler::define(scope, prototype)?;
    super::html_frame_set_element_ongamepadconnected_property::define(scope, prototype)?;
    super::html_frame_set_element_ongamepaddisconnected_property::define(scope, prototype)?;
    crate::webidl::finish_constructor(scope, prototype, constructor)?;
    let stored = v8::Global::new(scope, constructor);
    scope
        .get_slot_mut::<HtmlFrameSetElementStore>()
        .ok_or_else(|| "HTMLFrameSetElement state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn create<'s>(
    ...
    if crate::webidl::set_platform_prototype(scope, object, prototype.into()) != Some(true) {
        return Err("cannot create HTMLFrameSetElement".to_owned());
    }
    super::html_element::attach(scope, object, "FRAMESET");
    scope
        .get_slot_mut::<HtmlFrameSetElementStore>()
        .ok_or_else(|| "HTMLFrameSetElement state was not prepared".to_owned())?
        .records
        .insert(object.get_identity_hash().get(), FrameSetRecord::default());
    Ok(object)
}
...
pub(crate) fn get_rows(
    ...
    if let Some(record) = record(scope, a.this()) {
        if let Some(value) = v8::String::new(scope, &record.rows) {
            r.set(value.into())
        }
    } else {
        crate::webidl::throw_type_error(scope, "Illegal invocation")
...
pub(crate) fn set_handler(
    ...
    let value = a.get(0);
    let stored = if value.is_null() || value.is_undefined() {
        None
    } else {
