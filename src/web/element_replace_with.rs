pub(crate) fn define(
    ...
    crate::webidl::define_method(scope, prototype, "replaceWith", 0, replace_with)
}
...
fn replace_with(
    ...
    if super::node::parent(scope, arguments.this()).is_some_and(|current| {
        current.get_identity_hash().get() == parent.get_identity_hash().get()
    }) {
