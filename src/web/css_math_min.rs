...
#[derive(Default)]
pub(crate) struct CssMathMinStore {
    constructor: crate::webidl::RealmConstructor,
    values: HashMap<i32, v8::Global<v8::Object>>,
}

pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(CssMathMinStore::default());
}

pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "CSSMathMin", constructor.into())
}
...
fn ensure_constructor<'s>(
    ...
    scope
        .get_slot_mut::<CssMathMinStore>()
        .ok_or_else(|| "CSSMathMin state was not prepared".to_owned())?
        .constructor
...
fn construct(
    ...
    if !arguments.is_construct_call() || arguments.length() < 1 {
        crate::webidl::throw_type_error(scope, "CSSMathMin arguments cannot be empty");
        return;
    }
    ...
    scope
        .get_slot_mut::<CssMathMinStore>()
        .expect("CSSMathMin state")
        .values
        .insert(arguments.this().get_identity_hash().get(), values);
    super::css_math_value::attach(scope, arguments.this(), "min");
...
pub(crate) fn serialize(
    ...
    let mut output = String::from("min(");
