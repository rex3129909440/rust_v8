...
#[derive(Default)]
pub(crate) struct HtmlHeadingElementStore {
    pub(crate) constructor: crate::webidl::RealmConstructor,
    pub(crate) alignments: HashMap<i32, String>,
}
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(HtmlHeadingElementStore::default());
}
pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "HTMLHeadingElement", constructor.into())
}
pub(crate) fn ensure_constructor<'s>(
    ...
    super::html_heading_element_align_property::define(scope, prototype)?;
    crate::webidl::finish_constructor(scope, prototype, constructor)?;
    let stored = v8::Global::new(scope, constructor);
    scope
        .get_slot_mut::<HtmlHeadingElementStore>()
        .ok_or_else(|| "HTMLHeadingElement state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn create<'s>(
    ...
    if crate::webidl::set_platform_prototype(scope, object, prototype.into()) != Some(true) {
        return Err("cannot create HTMLHeadingElement".to_owned());
    }
    let tag = format!("H{}", level.clamp(1, 6));
    super::html_element::attach(scope, object, &tag);
    scope
        .get_slot_mut::<HtmlHeadingElementStore>()
        .ok_or_else(|| "HTMLHeadingElement state was not prepared".to_owned())?
        .alignments
