...
#[derive(Default)]
pub(crate) struct SvgFeFloodElementStore {
...
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(SvgFeFloodElementStore::default());
}
pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let c = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "SVGFEFloodElement", c.into())
}
pub(crate) fn ensure_constructor<'s>(
    scope: &mut v8::PinScope<'s, '_>,
) -> Result<v8::Local<'s, v8::Function>, String> {
    let old = scope
        .get_slot::<SvgFeFloodElementStore>()
    ...
    super::svg_fe_flood_element_x_property::define(scope, p)?;
    super::svg_fe_flood_element_y_property::define(scope, p)?;
    super::svg_fe_flood_element_width_property::define(scope, p)?;
    super::svg_fe_flood_element_height_property::define(scope, p)?;
    super::svg_fe_flood_element_result_property::define(scope, p)?;
    ...
    scope
        .get_slot_mut::<SvgFeFloodElementStore>()
        .ok_or_else(|| "SVGFEFloodElement state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn create<'s>(
    ...
    let c = ensure_constructor(scope)?;
    let object = super::svg_element::create_with_constructor(scope, c, "feFlood", owner)?;
...
pub(crate) fn illegal_constructor(
    ...
    crate::webidl::throw_type_error(
        s,
        "Failed to construct 'SVGFEFloodElement': Illegal constructor",
    )
}
pub(crate) fn record(s: &v8::PinScope<'_, '_>, o: v8::Local<'_, v8::Object>) -> Option<Record> {
    s.get_slot::<SvgFeFloodElementStore>()?
        .records
