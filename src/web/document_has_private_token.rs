pub(crate) fn define(
    ...
    crate::webidl::define_method(scope, prototype, "hasPrivateToken", 1, call)
}
...
fn call(
    ...
    if !trustworthy {
        let message = "Failed to execute 'hasPrivateToken' on 'Document': hasPrivateToken: Private Token issuer origins must be both HTTP(S) and secure (\"potentially trustworthy\").";
