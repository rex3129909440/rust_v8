...
#[derive(Default)]
pub(crate) struct CssMathInvertStore {
    constructor: crate::webidl::RealmConstructor,
    values: HashMap<i32, v8::Global<v8::Object>>,
}

pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(CssMathInvertStore::default());
}

pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "CSSMathInvert", constructor.into())
}
...
fn ensure_constructor<'s>(
    ...
    scope
        ...
        .ok_or_else(|| "CSSMathInvert state was not prepared".to_owned())?
        .constructor
...
fn construct(
    ...
    if !arguments.is_construct_call() || arguments.length() < 1 {
        crate::webidl::throw_type_error(scope, "CSSMathInvert requires one value");
        return;
    }
    ...
    scope
        .get_slot_mut::<CssMathInvertStore>()
        .expect("CSSMathInvert state")
        .values
        .insert(arguments.this().get_identity_hash().get(), value);
    super::css_math_value::attach(scope, arguments.this(), "invert");
