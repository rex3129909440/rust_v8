// Microsoft Edge 150.0.4078.65 HTTPS evidence: own supported CSS properties.
// Static evidence data only; API functions are implemented in their dedicated modules.
pub(crate) const EDGE_150_SUPPORTED_PROPERTIES: &[&str] = &[
    "accentColor",
    "additiveSymbols",
    "alignContent",
    "alignItems",
...
pub(crate) fn contains(name: &str) -> bool {
    EDGE_150_SUPPORTED_PROPERTIES.binary_search(&name).is_ok()
}
