...
#[derive(Default)]
pub(crate) struct SvgFeImageElementStore {
...
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(SvgFeImageElementStore::default());
}

pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "SVGFEImageElement", constructor.into())
}
...
pub(crate) fn ensure_constructor<'s>(
    ...
    let old = scope
        .get_slot::<SvgFeImageElementStore>()
    ...
    super::svg_fe_image_element_preserve_aspect_ratio_property::define(scope, p)?;
    super::svg_fe_image_element_x_property::define(scope, p)?;
    super::svg_fe_image_element_y_property::define(scope, p)?;
    super::svg_fe_image_element_width_property::define(scope, p)?;
    super::svg_fe_image_element_height_property::define(scope, p)?;
    super::svg_fe_image_element_result_property::define(scope, p)?;
    super::svg_fe_image_element_href_property::define(scope, p)?;
    ...
    scope
        .get_slot_mut::<SvgFeImageElementStore>()
        .ok_or_else(|| "SVGFEImageElement state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn create<'s>(
    ...
    let object = super::svg_element::create_with_constructor(scope, c, "feImage", owner)?;
...
pub(crate) fn illegal_constructor(
    ...
    crate::webidl::throw_type_error(
        s,
        "Failed to construct 'SVGFEImageElement': Illegal constructor",
    )
}
pub(crate) fn record(s: &v8::PinScope<'_, '_>, o: v8::Local<'_, v8::Object>) -> Option<Record> {
    s.get_slot::<SvgFeImageElementStore>()?
        .records
...
pub(crate) fn get_preserve_aspect_ratio(
    ...
    if let Some(v) = record(s, a.this()) {
        ret(s, &v.preserve_aspect_ratio, r)
    } else {
