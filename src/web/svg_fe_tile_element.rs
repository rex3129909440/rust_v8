...
#[derive(Default)]
pub(crate) struct SvgFeTileElementStore {
...
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(SvgFeTileElementStore::default());
}

pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "SVGFETileElement", constructor.into())
}
...
pub(crate) fn ensure_constructor<'s>(
    ...
    let existing = scope
        .get_slot::<SvgFeTileElementStore>()
    ...
    super::svg_fe_tile_element_in1_property::define(scope, prototype)?;
    super::svg_fe_tile_element_x_property::define(scope, prototype)?;
    super::svg_fe_tile_element_y_property::define(scope, prototype)?;
    super::svg_fe_tile_element_width_property::define(scope, prototype)?;
    super::svg_fe_tile_element_height_property::define(scope, prototype)?;
    super::svg_fe_tile_element_result_property::define(scope, prototype)?;
    ...
    scope
        .get_slot_mut::<SvgFeTileElementStore>()
        .ok_or_else(|| "SVGFETileElement state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn create<'s>(
    ...
    let constructor = ensure_constructor(scope)?;
    let object = super::svg_element::create_with_constructor(scope, constructor, "feTile", owner)?;
...
pub(crate) fn illegal_constructor(
    ...
    crate::webidl::throw_type_error(
        scope,
        "Failed to construct 'SVGFETileElement': Illegal constructor",
    );
}
pub(crate) fn record(
