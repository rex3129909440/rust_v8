...
pub(crate) fn install(s: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let c = ensure(s)?;
    crate::webidl::define_global(s, "XRViewport", c.into())
}
fn ensure<'s>(s: &mut v8::PinScope<'s, '_>) -> Result<v8::Local<'s, v8::Function>, String> {
    if let Some(v) = s
        .get_slot::<XrViewportStore>()
    ...
    crate::webidl::define_readonly_accessor(s, p, "x", zero)?;
    crate::webidl::define_readonly_accessor(s, p, "y", zero)?;
