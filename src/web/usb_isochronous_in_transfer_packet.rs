...
#[derive(Default)]
pub(crate) struct UsbIsochronousInTransferPacketStore {
    constructor: crate::webidl::RealmConstructor,
    records: HashMap<i32, PacketData>,
}
pub(crate) fn prepare(i: &mut v8::OwnedIsolate) {
    i.set_slot(UsbIsochronousInTransferPacketStore::default());
}
pub(crate) fn install(s: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let c = ensure(s)?;
    crate::webidl::define_global(s, "USBIsochronousInTransferPacket", c.into())
}
fn ensure<'s>(s: &mut v8::PinScope<'s, '_>) -> Result<v8::Local<'s, v8::Function>, String> {
    let realm_id = crate::webidl::realm_id(s);
    if let Some(v) = s
        .get_slot::<UsbIsochronousInTransferPacketStore>()
    ...
    s.get_slot_mut::<UsbIsochronousInTransferPacketStore>()
        .unwrap()
        .constructor
...
fn construct(
    ...
    if a.get(0).is_null_or_undefined() {
        ...
        crate::webidl::throw_type_error(
            s,
            &format!(
                "Failed to construct 'USBIsochronousInTransferPacket': The provided value '{status}' is not a valid enum value of type USBTransferStatus."
            ),
        );
        return;
    }
...
pub(crate) fn create<'s>(
    ...
    if crate::webidl::set_platform_prototype(s, o, p.into()) != Some(true) {
        return Err("cannot create USBIsochronousInTransferPacket".to_owned());
    }
    s.get_slot_mut::<UsbIsochronousInTransferPacketStore>()
        .unwrap()
        .records
        .insert(o.get_identity_hash().get(), PacketData { status, bytes });
    Ok(o)
}
fn record(s: &v8::PinScope<'_, '_>, o: v8::Local<'_, v8::Object>) -> Option<PacketData> {
    s.get_slot::<UsbIsochronousInTransferPacketStore>()?
        .records
...
pub(crate) fn cleanup_realm(scope: &mut v8::PinScope<'_, '_>, realm_id: i32) {
    if let Some(store) = scope.get_slot_mut::<UsbIsochronousInTransferPacketStore>() {
