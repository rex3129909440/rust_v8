...
fn get_timeline(
    ...
    if super::document_property_support::return_stored(s, a.this(), "timeline", r) {
        return;
    }
    match super::document_timeline::create(s, 0.0) {
        Ok(value) => {
            super::document::remember_value(s, a.this(), "timeline", value.into());
            r.set(value.into());
        }
