pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    ...
    let key = crate::webidl::string(scope, "setTimeout")?;
    ...
    ) == Some(true)
    {
        ...
        Err("cannot define window.setTimeout".to_owned())
    }
}
...
fn set_timeout(
    ...
    let id = super::timer_state::reserve_timeout(scope, callback, callback_arguments, delay);
