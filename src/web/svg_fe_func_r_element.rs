#[derive(Default)]
pub(crate) struct SvgFeFuncRElementStore {
    constructor: crate::webidl::RealmConstructor,
}
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(SvgFeFuncRElementStore::default());
}
pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let c = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "SVGFEFuncRElement", c.into())
}
fn ensure_constructor<'s>(
    scope: &mut v8::PinScope<'s, '_>,
) -> Result<v8::Local<'s, v8::Function>, String> {
    let old = scope
        .get_slot::<SvgFeFuncRElementStore>()
    ...
    scope
        .get_slot_mut::<SvgFeFuncRElementStore>()
        .ok_or_else(|| "SVGFEFuncRElement state was not prepared".to_owned())?
        .constructor
...
fn illegal_constructor(
    ...
    crate::webidl::throw_type_error(
        s,
        "Failed to construct 'SVGFEFuncRElement': Illegal constructor",
    )
}
