...
#[derive(Default)]
pub(crate) struct SvgPolylineElementStore {
...
pub(crate) fn prepare(isolate: &mut v8::OwnedIsolate) {
    isolate.set_slot(SvgPolylineElementStore::default());
}

pub(crate) fn install(scope: &mut v8::PinScope<'_, '_>) -> Result<(), String> {
    let constructor = ensure_constructor(scope)?;
    crate::webidl::define_global(scope, "SVGPolylineElement", constructor.into())
}
...
pub(crate) fn ensure_constructor<'s>(
    ...
    let existing = scope
        .get_slot::<SvgPolylineElementStore>()
    ...
    super::svg_polyline_element_points_property::define(scope, prototype)?;
    super::svg_polyline_element_animated_points_property::define(scope, prototype)?;
    ...
    scope
        .get_slot_mut::<SvgPolylineElementStore>()
        .ok_or_else(|| "SVGPolylineElement state was not prepared".to_owned())?
        .constructor
...
pub(crate) fn illegal_constructor(
    ...
    crate::webidl::throw_type_error(
        scope,
        "Failed to construct 'SVGPolylineElement': Illegal constructor",
    );
}
